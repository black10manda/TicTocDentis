<div class="content-wrapper">
    <!-- Content Header (Page header) -->
          ...
          <div class="row">
            ...
            <div class="col-xs-10">
              <div class="well text-center">
                <h3><i class="fa fa-user  text-warning"></i> Editar Paciente</h3>
              </div>
            </div>
            <div class="col-xs-1"></div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-xs-10">
          <div class="well text-center">
          <h3><i class="fa fa-history  text-warning"></i> Editar Historia Odontologica</h3>
        </div>
        </div>
        <div class="col-xs-1"></div>
      </div>
        ...
        <div class="col-xs-10">
          <div class="well text-center">
          <h3><i class="fa fa-user-md  text-warning"></i>Editar Examen Oral</h3>
        </div>
        </div>
        </div>
        <div class="row">
       ...
       <div class="col-xs-1">
        <button  type="submit" class="btn btn-warning btn-lg">Editar <i class="fa  fa-pencil-square-o    " aria-hidden="true"></i></button></div>
        </div>
      </div>
