...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class=""><a href="<?=base_url(); ?>index.php/Calendario/cal"><i class="fa  fa-calendar"></i> <span>Agenda</span></a></li>
      <li class="active"><a href="<?=base_url(); ?>"><i class="fa  fa-users "></i> <span>Historia Clinica</span></a></li>
      <li class="treeview">
